            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>{form.watch('type') === 'ollama' ? 'Required. Also used for quota polling.' : 'Used for CPA sync and quota polling. Optional for opencode (cookie fallback).'}</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
